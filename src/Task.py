...
class Task(object):
    ...
    def get_cookie(self, user_type="0"):
        try:
            ...
            with open('../other/stealth.min.js') as f:
                js = f.read()
            ...
            if user_type == "0":
                ...
                pickle.dump(self.driver.get_cookies(), open("../other/cookies_test.pkl", "wb"))
            else:
                pickle.dump(self.driver.get_cookies(), open("../other/cookies.pkl", "wb"))
    ...
    def ckeck_cookie(self):
        ...
        if not os.path.exists("../other/cookies_test.pkl"):
            ...
            # 获取文件创建时间
            mtime = os.path.getmtime("../other/cookies_test.pkl")
